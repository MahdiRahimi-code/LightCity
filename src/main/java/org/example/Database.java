...
public class Database {
    ...
    public static void ReadData() {
        try {
            ...
            // Data.bankAccounts.add(new BankAccount(bankAccount.getString("Owner"),
            // bankAccount.getString("Password"), bankAccount.getFloat("Money"), date));
            // }
            //
            // ResultSet bankTurnOver = stmt.executeQuery("SELECT * FROM bankturnover");
            // while(bankTurnOver.next()){
            // Data.bankTurnovers.add(new BankTurnover(bankTurnOver.getFloat("Withdraw"),
            // bankTurnOver.getFloat("Deposit")));
            // }
            ...
            // break;
            // }
            // Data.characters.add(new Character(character.getString("UserInfo"),
            // bankAccount1, ))
            // }
    ...
    //// query example
    // String query = "CREATE TABLE IF NOT EXISTS Users (username varchar(255)
